...
DEBUG = False
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'cowsville-aau-cvma.com,api.cowsville-aau-cvma.com,www.cowsville-aau-cvma.com,apiv3.cowsville-aau-cvma.com,*').split(',')
...
# Database configuration - supports PostgreSQL (recommended) or MySQL
